                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      >
                        ...
                        <optgroup label="Automatic Washes">
                          <option value="express-wash">Express Wash - $12 (5 min)</option>
                          <option value="deluxe-wash">Deluxe Wash - $22 (10 min)</option>
                          <option value="ultimate-wash">Ultimate Wash - $35 (15 min)</option>
                        </optgroup>
                        <optgroup label="Detailing Services">
                          <option value="interior-detail">Interior Detailing - $75 (45-60 min)</option>
                          <option value="full-detail">Full Detail Package - $150 (2-3 hrs)</option>
                        </optgroup>
                        <optgroup label="Other Services">
                          <option value="self-service">Self-Service Bay - $3+ (Pay per minute)</option>
                          <option value="pet-wash">Pet Wash Station - $15</option>
                        </optgroup>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="downtown-scranton">West Hazleton</option>
                        <option value="wilkes-barre">Dallas</option>
                      </select>
                    </div>
