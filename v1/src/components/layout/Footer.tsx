...
const footerNavigation = {
  services: [
    { name: 'Express Wash', href: '/services/express-wash' },
    { name: 'Deluxe Wash', href: '/services/deluxe-wash' },
    { name: 'Ultimate Wash', href: '/services/ultimate-wash' },
    { name: 'Full Detail', href: '/services/full-detail' },
  ],
  membership: [
    { name: 'Basic Shine', href: '/pricing#basic' },
    { name: 'Premium Gloss', href: '/pricing#premium' },
    { name: 'Ultimate Protect', href: '/pricing#ultimate' },
          ...
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-5">
            ...
            <div className="col-span-2">
              ...
              <p className="mt-4 max-w-xs text-sm">
                Premium car wash service with AI-powered features. Keeping your vehicle spotless,
                inside and out.
              </p>
